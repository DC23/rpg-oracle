...
hiding in this system. The \emph{and \ldots} result is the extreme outcome.
Unlike Mythic, this system also gives mixed results that can
be interpreted as \emph{success with a cost} and \emph{failure with a
consolation}. The \emph{but \ldots} result reduces the impact of the oracle result. 
It's the opposite of extreme, a \emph{mild yes or no} if you like.
