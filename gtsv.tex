...
% Yuk, I hate having to manually force the line breaks in this table, but it's the only
% way to pack it into the column width
...
% Mythic odds
\begin{DndTable}[header=Mythic GME Scene Setup Probabilities]{X c c c c}
    \textbf{Modifier} & \textbf{Chaos 6} & \textbf{Chaos 5} & \textbf{Chaos 4} & \textbf{Chaos 3}\\
...
% Classic table
\begin{DndTable}[header=Table 1: GTSV Classic (Mythic) Scene Setup]{X c c c c c c c}
