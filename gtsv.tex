...
In the original MCSV, modifiers occur too frequently for my preference. I have
reduced the modifier odds to be a close match to Mythic. For those that prefer
the original MCSV modifier odds, I have kept those as an optional table.
...
% This is an optional table for qualifiers. It retains the original MCSV modifier
% frequencies.
