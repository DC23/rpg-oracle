...
So I mashed up some ideas from Mythic, MCSV, and the excellent
...
\begin{DndTable}[header=PUM v3]{c X}
    \textbf{Chaos} & \textbf{Outcome} \\
...
\begin{DndTable}[header=\emph{Mythic Variations 2 Fate Check}]{l c c c c}
    \textbf{Modifier} & \textbf{Chaos 3} & \textbf{Chaos 4} & \textbf{Chaos 5} & \textbf{Chaos 6}\\
    Exceptional             & $8\%$          & $10\%$            & $12\%$              & $15\%$ \\
    Random                  & $8\%$          & $10\%$            & $12\%$              & $15\%$ \\
    Exceptional \& Random   & $3\%$          & $4\%$             & $5\%$               & $6\%$ \\
    Unmodified              & $82\%$         & $76\%$            & $70\%$              & $64\%$ \\
\end{DndTable}
...
% Mythic table
\begin{DndTable}[header=Mythic Scene Setup Table]{X c c c c c c c}
...
% Mythic & PUM v2
\begin{DndTable}[header=Mythic \& PUM v2 Scene Setup Table]{X c c c c c c c}
    \textbf{Outcome}        & \textbf{d4} & \textbf{d5} & \textbf{d6} & \textbf{d8} & \textbf{d10} & \textbf{d12} & \textbf{d20}\\
...
% PUM v3
\begin{DndTable}[header=PUM v3 Scene Setup Table]{X c c c c c c c}
    \textbf{Outcome}        & \textbf{d4} & \textbf{d5} & \textbf{d6} & \textbf{d8} & \textbf{d10} & \textbf{d12} & \textbf{d20}\\
